...
class PointsMesh{
    ...
    constructor( maxLen=100, name="points" ){
        this.cnt		= 0;	// How many items are in the buffer.
        this.use_size	= 1;	// Default size to use
        this.use_shape	= 1;	// Default Shape to use

        this.buf_pos    = null; // Interleaved Data : XYZ - Position, W - Size
        this.buf_cls    = null; // Interleaved Data : XYZ - Color, W - Shape
    ...
    _init( maxLen=100, name="points" ){
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        // BUFFERS
        this.buf_pos = new THREE.BufferAttribute( new Float32Array( maxLen * 4 ), 4 );
        this.buf_pos.setUsage( THREE.DynamicDrawUsage );

        this.buf_clr = new THREE.BufferAttribute( new Float32Array( maxLen * 4 ), 4 );
    ...
    addRaw( x, y, z, hex=0xff0000, size=null, shape=null ){
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
